...
namespace Scraper
{
    ...
    //        Console.WriteLine(NewRecoveries(ref result, new DateTime(2021, 3, 9)));
    //        Console.WriteLine(NewActives(ref result, new DateTime(2021, 3, 9)));
    ...
    //    public static double NewRecoveries(ref IEnumerable<StatsModel> lista, DateTime date)
    //    {
    //        StatsModel day = lista.First(x => x.Last_Update == date);
    //        StatsModel theDayBefore = lista.First(x => x.Last_Update == date.AddDays(-1));

    //        return day.Recovered - theDayBefore.Recovered;

    //    }

    //    public static double NewActives(ref IEnumerable<StatsModel> lista, DateTime date)
    //    {
    //        StatsModel day = lista.First(x => x.Last_Update == date);
    //        StatsModel theDayBefore = lista.First(x => x.Last_Update == date.AddDays(-1));

    //        return day.Active - theDayBefore.Active;
